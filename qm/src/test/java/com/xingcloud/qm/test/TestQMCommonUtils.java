...
//
//    s = "select * from a";
//    assertFalse("Do not has group by, should return false.",
//                hasGroupByKeyWord(s));
//
//    s = "select * from a groupby a";
//    assertFalse("Wrong group by key words, should return false.",
//                hasGroupByKeyWord(s));
//
//    s = "select * from a Group by a";
//    assertFalse(
//        "Group by key word are not all upper case, should return false.",
//        hasGroupByKeyWord(s));
//
